...
"""
Default configuration for WsgiDAVApp

Reference to https://wsgidav.readthedocs.io/en/latest/user_guide_configure.html
"""
...
# Use these settings, if config file does not define them
# (oris totally missing)
DEFAULT_VERBOSE = 3
...
DEFAULT_CONFIG = {
    ...
    "host": "localhost",
    "port": 8080,
    "mount_path": None,  # Application root, e.g.
    ...
    "http_authenticator": {
        ...
        "default_to_digest": True,  # True (default digest) or
                                    # False (default basic)
    ...
    "dir_browser": {
        ...
        # Invoke MS Office documents for editing using WebDAV
        "libre_office_support": True,
        # Invoke Libre Office documents forediting using WebDAV
